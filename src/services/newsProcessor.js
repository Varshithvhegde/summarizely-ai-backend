...
const { summarizeAndAnalyze, generateEmbedding } = require('./geminiService');
const { storeArticle, articleExists } = require('./redisService');
...
// Schedule news processing (commented out by default)
// Run every 10 minutes
// cron.schedule('*/10 * * * *', processNews);

// Run once at startup (commented out by default)
// processNews();
